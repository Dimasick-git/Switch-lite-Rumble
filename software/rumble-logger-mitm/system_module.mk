...
#
# NOTE: adapted from Atmosphère's stratosphere/<module>/system_module.mk. The only
# change from upstream is the include path below: our libstratosphere submodule (the
# Atmosphere-libs repo) lives at ./libstratosphere instead of ../../libraries.
#---------------------------------------------------------------------------------
THIS_MAKEFILE := $(abspath $(lastword $(MAKEFILE_LIST)))
CURRENT_DIRECTORY := $(abspath $(dir $(THIS_MAKEFILE)))
include $(CURRENT_DIRECTORY)/libstratosphere/config/templates/stratosphere.mk
