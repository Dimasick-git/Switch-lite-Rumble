...
| [`references/`](./references/) | Upstream projects we study/reuse, as pinned git submodules (our MissionControl fork, dekuNukem RE, sys-con, switch-examples, nxdumptool) — fetch with `git submodule update --init` |
| [`community/`](./community/) | [Thread-stats](./community/thread-stats.md) auto-recorded daily by a GitHub Action from the GBAtemp discussion |
